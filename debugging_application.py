...
# ==========================================
# 1. THE LOGGER HEADER (V6.1 - Aliased Datetime)
# ==========================================
def generate_header():
    # We use a raw string for the header or double-escape backslashes 
    # so the injected file gets proper \n characters.
    return """
# ==========================================
...
# ==========================================
# 3. THE INJECTION ENGINE (State Tracking Enabled)
# ==========================================
