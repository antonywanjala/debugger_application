...
# ==========================================
# 1. THE LOGGER HEADER (V6.0 - State Tracking)
# ==========================================
def generate_header():
    return """
# ==========================================
# STRICT RECURSIVE WRAPPER + STATE TRACKER (V6.0)
# ==========================================
    ...
    try:
        with open("_VARIABLE_TRACKER.csv", "a", encoding="utf-8", newline='') as f:
            ...
            for var_name, var_val in local_vars.items():
                # Skip internal/private underscore variables to keep CSV clean
                if var_name.startswith('_'): continue 
                # Sanitize value for CSV (remove newlines/tabs)
...
# ==========================================
# 3. THE INJECTION ENGINE (Enhanced for State)
# ==========================================
